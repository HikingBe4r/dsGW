...
$(document).ready(function() {   
  	...
  	$("#deleteBtn").click(function(){
  		location.href='removeArticle.do?id=${requestScope.article.id}&boardId=${param.boardId}';
  	});
  	
  	$("#modifyBtn").click(function(){
  		location.href='modifyArticle.do?id=${requestScope.article.id}&boardId=${param.boardId}';
  	});
