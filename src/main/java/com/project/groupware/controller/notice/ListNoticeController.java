...
public class ListNoticeController {
	...
	@RequestMapping(value = "/listNoticePaging.do", method = RequestMethod.GET)
	public ModelAndView listNoticePaging(@RequestParam(value = "currentPage", required = true) Integer currentPage ,HttpSession session){
		ModelAndView mv = new ModelAndView();
